...
begin
  ...
  values (p_user_id, p_target_summary_id, p_source_url, p_fallback_title, p_fallback_site, (now() at time zone 'Asia/Seoul'))
  ...
  do update set
    ...
    last_requested_at = (now() at time zone 'Asia/Seoul')
